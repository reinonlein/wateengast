...
class Cardstrings {
  ...
  String get literstring {
    ...
    if (bier + wijn + sterk == 0) {
      ...
      literstring =
          'Sinds je gestopt bent heb je gewoon ${((stopuren / (7 * 24)) * bier * 0.250).round()} liter bier niet gedronken! \n\nStel je voor zeg, bij elkaar is dat dus gewoon ${((((stopuren / (7 * 24)) * bier * 0.250).round() + ((stopuren / (7 * 24)) * wijn * 0.125).round() + ((stopuren / (7 * 24)) * sterk * 0.035).round()) / 150).toStringAsFixed(1)} keer een gemiddelde badkuip vol bier!\n\nEn ook niet onbelangijk: dat ${(((stopuren / (7 * 24)) * bier * 0.250).ceil() / 7.2).ceil() == 1 ? 'is' : 'zijn'} dus ${(((stopuren / (7 * 24)) * bier * 0.250).ceil() / 7.2).toStringAsFixed(0)} ${(((stopuren / (7 * 24)) * bier * 0.250).ceil() / 7.2).ceil() == 1 ? 'leeg krat dat' : 'lege kratten die'} je mooi niet hoefde weg te brengen! Dat scheelt een hoop gesjouw. Lekker bezig!';
    } else if (bier + sterk == 0) {
      literstring =
          'Sinds je gestopt bent heb je gewoon ${((stopuren / (7 * 24)) * wijn * 0.125).round()} liter wijn laten staan. \n\nStel je voor zeg, bij elkaar is dat dus gewoon ${((((stopuren / (7 * 24)) * wijn * 0.125).round()) / 150).toStringAsFixed(1)} keer een gemiddelde badkuip vol wijn!\n\nEn ook niet onbelangijk: dat zijn dus ${((stopuren / (7 * 24)) * wijn * 0.125).round()} ${((stopuren / (7 * 24)) * wijn * 0.125).round() == 1 ? 'fles' : 'flessen'} die je mooi niet hoefde weg te brengen naar de glasbak. Hoe relaxed!';
    } else if (bier + wijn == 0) {
      literstring =
          'Sinds je gestopt bent heb je gewoon ${((stopuren / (7 * 24)) * sterk * 0.035).round()} liter sterke drank laten staan. \n\nStel je voor zeg, bij elkaar is dat dus gewoon ${((((stopuren / (7 * 24)) * sterk * 0.035).round()) / 150).toStringAsFixed(1)} keer een gemiddelde badkuip vol sterke drank!\n\nEn ook niet onbelangijk: dat zijn dus ${((((stopuren / (7 * 24)) * sterk * 0.035).round()) / 0.750).round()} ${((((stopuren / (7 * 24)) * sterk * 0.035).round()) / 0.750).round() == 1 ? 'fles' : 'flessen'} die je mooi niet hoefde weg te brengen naar de glasbak. Hoe relaxed!';
    } else if (bier == 0) {
      literstring =
